...
while read srcfile tgtfile msg ; do
    case $srcfile in
        "$")
            ...
            ;;
        *)
            [ ! -e "$srcfile" ] && echo "! src $srcfile not found. Fix $ctrlfile.csv" && exit 3
...
[ -e $ctrlfile.md ] && echo "! $ctrlfile.md already exists. I wont overwrite it. Fix." && exit 5
echo "
